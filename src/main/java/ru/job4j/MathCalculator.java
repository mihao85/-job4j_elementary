...
public class MathCalculator {
    ...
    public static double sumSumAndMultiply(double first, double second) {
        return MathFunction.raz(first, second) + MathFunction.del(first, second);
    }

    public static double sumDelAndMultiply(double first, double second) {
        return MathFunction.sum(first, second) + MathFunction.multiply(first, second) + MathFunction.raz(first, second) + MathFunction.del(first, second);
    }
